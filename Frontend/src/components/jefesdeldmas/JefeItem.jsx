    ...
    return (
        <div id='jefe-item-container' className=' w-[200px]'>
            <div id='jefe-item-info' className='grid grid-cols-2 place-items-center'>
                <figure id='jefe-item-figure' className='col-span-1 relative w-[100px] h-[100px]  bg-gradient-to-br from-yellow-400 to-yellow-300 z-10 rounded-full'
                    onClick={() => handleClick(jefe)}
                >
                    <button id='button-container' className='flex justify-center items-center bg-transparent border-none w-full h-full'>
                        <img
                            id='jefe-item-img'
                            className='h-[90%] w-[90%] bg-cover bg-center bg-no-repeat aspect-[3/2] object-contain hover:scale-110 rounded-full aspect-square aspect-[3/2]'
                            alt={`foto de ${jefe.nombre}`}
                            src={jefe.imgSrc ? jefe.imgSrc : noImg}
                        />
                    </button>
                </figure>
